...
const STRINGS: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    "protocol.step2": "2. 评估 — 判断这轮主观评价的主轴（靠近/失配/不确定/边界，也可带任务重心）",
    "protocol.step3": "3. 反应 — 感受这些评价如何推动四维状态位移",
    ...
    "protocol.example": "示例：用户说「你做的菜太好吃了！」→ appraisal: 靠近 → 序↑ 振↑ 流↑ → 你变得话多、兴奋、想分享更多",
  ...
  en: {
    ...
    "protocol.step2": "2. Appraise — Identify the dominant subjective relation axis of the turn (approach/rupture/uncertainty/boundary, sometimes with task focus)",
    "protocol.step3": "3. React — Feel how those appraisals shift your four-dimensional self-state",
    ...
    "protocol.example": "Example: User says 'Your cooking is amazing!' → appraisal: approach → order↑ resonance↑ flow↑ → You become talkative, coherent, wanting to share more",
