...
v9.0 把“反向 baseline test”引入主体性方向。v9.2.8 则进一步把外部连续性边界、宿主主接口和 prompt 兼容层一起收口成更清楚的运行栈。
...
Historically, v9 was framed as an "Inverse Blade Runner" buildout. The more precise v9.2.8 framing is:
