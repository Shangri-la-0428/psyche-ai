...
v9.2.6 在这个基础上继续做两件事：一是把关系动力学和持续主体偏置接进热路径，二是把回应调节做成可观测、可回看的闭环，而不是单向建议，并把对外发现链路统一到官网、npm 和 GitHub。
...
Historically, v9 was framed as an "Inverse Blade Runner" buildout. The more precise v9.2.6 framing is:
